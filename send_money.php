...
<body style="padding-top:8%; margin-top: 70px;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="images\logo-bs.png" alt=""
...
<img src="images/sm-img.png" class="zoomin" alt="" style="margin-left: 200px; height: 500px; width: 1000px; margin-right: 50px;">
        ...
        <div class="container" style="margin-top:2%; margin-left: 10%;">
            ...
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px;  ">
                <form action="send_money.php" method="post">
                    <table>
                        <tr>
                            <td><input type="text" class="formin form-control" name="AccountNo1" id=""
                        ...
                        <tr>
                            <td><input type="text" class="formin form-control" name="AccountNo2" id=""
                                    placeholder="Reciever's Account Number"></td>
                        </tr>
                    </table>
                    <br><input class="btn mybtn btn-outline-light" type="submit" value="Transfer" style="color: black; margin-left: 150px;"><br>
                    <p style="margin-left: 70px;">To check your balance click <a href="check_blc.php">here</a></p>
                </form>
            </div>
        </div>
    </div>
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sender = $_POST['AccountNo1'];
    $amount = $_POST['amount'];
    $reciever = $_POST['AccountNo2'];
   
    
    $checkblcquery = "SELECT Balance FROM users Where AccountNo='$sender'";
    $checkblc = mysqli_query($conn, $checkblcquery);
    $ava_blc = mysqli_fetch_assoc($checkblc)['Balance'];

    if($ava_blc >= $amount){
    $sql1 = "UPDATE users SET Balance = Balance-'$amount' WHERE AccountNo='$sender'";
    $sql2 = "UPDATE users SET Balance= Balance+ '$amount' WHERE AccountNo='$reciever'";
